...
echo $pane->startPanel(JText::_('COM_VIRTUEMART_ADMIN_PAYMENT_FORM'), 'payment_edit');
echo $this->loadTemplate('edit');
echo $pane->endPanel();
echo $pane->startPanel(JText::_('COM_VIRTUEMART_ADMIN_PAYMENT_CONFIGURATION'), 'payment_config');
