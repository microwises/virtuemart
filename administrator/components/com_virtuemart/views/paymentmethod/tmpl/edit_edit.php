    ...
    */ ?>
	...
	<tr class="row1">
      ...
      <td width="69%" >
		...
		<?php
		echo JHTML::_('select.booleanlist',  'is_discount', 'class="inputbox"', $this->paym->discount_is_percentage, 'COM_VIRTUEMART_PRODUCT_DISCOUNT_ISTOTAL', 'COM_VIRTUEMART_PRODUCT_DISCOUNT_ISPERCENT');
