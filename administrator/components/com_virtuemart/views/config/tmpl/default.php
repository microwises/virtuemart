...
echo $pane->startPanel(JText::_('VM_ADMIN_CFG_SYSTEM'), 'system_panel');
echo $this->loadTemplate('system');
echo $pane->endPanel();
echo $pane->startPanel(JText::_('VM_ADMIN_CFG_SHOP'), 'shop_panel');
echo $this->loadTemplate('shop');
echo $pane->endPanel();
echo $pane->startPanel(JText::_('VM_ADMIN_CFG_SHOPFRONT'), 'shopfrotnl_panel');
