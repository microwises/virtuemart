...
if (VmConfig::get('vm_registration_type') != 'NO_REGISTRATION' ) {
	...
	echo <?php echo JURI::root().'index.php?option=com_virtuemart&view=orders&task=details&order_number='.$this->orderdata['details']['BT']->order_number.'&order_pass='.$this->orderdata['details']['BT']->order_pass; ?>  . "\n"  . "\n";
}
echo '____________________________________________________________'  . "\n";
