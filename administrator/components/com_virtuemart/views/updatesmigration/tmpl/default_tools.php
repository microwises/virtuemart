...
<?php /*	<td align="center">
  ...
  <tr>
	...
	<td align="center">
	    ...
	    <div class="icon"><a onclick="javascript:confirmation('<?php echo JText::_('COM_VIRTUEMART_UPDATE_RESTOREDEFAULTS_CONFIRM_JS'); ?>', '<?php echo $link; ?>');">
	...
	<td align="center">
	    ...
	    <div class="icon"><a onclick="javascript:confirmation('<?php echo JText::_('COM_VIRTUEMART_UPDATE_REMOVEDATA_CONFIRM_JS'); ?>', '<?php echo $link; ?>');">
	...
	<td align="center">
	    ...
	    <div class="icon"><a onclick="javascript:confirmation('<?php echo JText::_('COM_VIRTUEMART_UPDATE_REMOVETABLES_CONFIRM_JS'); ?>', '<?php echo $link; ?>');">
		<span class="vmicon48 vm_trash_48"></span>
	    <br />
    ...
    <td align="center">
	   ...
	   <td align="center">
	    ...
	    <div class="icon"><a onclick="javascript:confirmation('<?php echo JText::_('COM_VIRTUEMART_UPDATEDATABASE_CONFIRM_JS'); ?>', '<?php echo $link; ?>');">
		<span class="vmicon48 vm_trash_48"></span>
	    <br />
