...
//	define( 'COM_VIRTUEMART_THEMEURL', SECUREURL.'components/com_virtuemart/assets/css/' );
} else {
	define( 'IMAGEURL', URL .'components/com_virtuemart/images/' );
//	define( 'COM_VIRTUEMART_THEMEURL', URL.'components/com_virtuemart/assets/css/' );
}
...
define( 'COM_VIRTUEMART_ADMIN_ICON_URL',COMPONENTURL.'assets/images/');
...
define('COM_VIRTUEMART_TABLEPREFIX', 'vm');
define('COM_VIRTUEMART_PRICE_SHOW_PACKAGING_PRICELABEL', '1');
define('COM_VIRTUEMART_PRICE_SHOW_INCLUDINGTAX', '');
define('COM_VIRTUEMART_PRICE_SHOW_EXCLUDINGTAX', '');
define('COM_VIRTUEMART_PRICE_SHOW_WITHTAX', '');
define('COM_VIRTUEMART_PRICE_SHOW_WITHOUTTAX', '');
define('COM_VIRTUEMART_PRICE_ACCESS_LEVEL', 'Public Frontend');
define('COM_VIRTUEMART_REGISTRATION_TYPE', 'NORMAL_REGISTRATION');
define('COM_VIRTUEMART_BROWSE_ORDERBY_FIELD', 'product_name');
define('COM_VIRTUEMART_GENERALLY_PREVENT_HTTPS', '1');
define('COM_VIRTUEMART_SHOW_REMEMBER_ME_BOX', '');
define('COM_VIRTUEMART_REVIEWS_MINIMUM_COMMENT_LENGTH', '100');
define('COM_VIRTUEMART_REVIEWS_MAXIMUM_COMMENT_LENGTH', '2000');
define('COM_VIRTUEMART_SHOW_PRINTICON', '1');
define('COM_VIRTUEMART_SHOW_EMAILFRIEND', '1');
define('PSHOP_PDF_BUTTON_ENABLE', '1');
define('COM_VIRTUEMART_REVIEWS_AUTOPUBLISH', '');
define('COM_VIRTUEMART_PROXY_URL', '');
define('COM_VIRTUEMART_PROXY_PORT', '');
define('COM_VIRTUEMART_PROXY_USER', '');
define('COM_VIRTUEMART_PROXY_PASS', '');
define('COM_VIRTUEMART_ONCHECKOUT_SHOW_LEGALINFO', '');
define('COM_VIRTUEMART_ONCHECKOUT_LEGALINFO_SHORTTEXT', '<h5>Returns Policy</h5> You can cancel this order within two weeks after we have received it. You can return new, unopened items from a cancelled order within 2 weeks after they have been delivered to you. Items should be returned in their original packaging. For more information on cancelling orders and returning items, see the <a href="%s" target="_blank">Our Returns Policy</a> page.');
define('COM_VIRTUEMART_ONCHECKOUT_LEGALINFO_LINK', '');
...
define('COM_VIRTUEMART_DOWNLOADABLE_PRODUCTS_KEEP_STOCKLEVEL', '');
...
define('COM_VIRTUEMART_CURRENCY_CONVERTER_MODULE', '');
define('COM_VIRTUEMART_CONTENT_PLUGINS_ENABLE', '');
define('COM_VIRTUEMART_ENABLE_COOKIE_CHECK', '1');
define('COM_VIRTUEMART_FEED_ENABLED', '1');
define('COM_VIRTUEMART_FEED_CACHE', '1');
define('COM_VIRTUEMART_FEED_CACHETIME', '3600');
define('COM_VIRTUEMART_FEED_TITLE', 'Latest Products from {storename}');
define('COM_VIRTUEMART_FEED_TITLE_CATEGORIES', '{storename} - Latest Products from Category: {catname}');
define('COM_VIRTUEMART_FEED_SHOW_IMAGES', '1');
define('COM_VIRTUEMART_FEED_SHOW_PRICES', '1');
define('COM_VIRTUEMART_FEED_SHOW_DESCRIPTION', '1');
define('COM_VIRTUEMART_FEED_DESCRIPTION_TYPE', 'product_s_desc');
define('COM_VIRTUEMART_FEED_LIMITTEXT', '1');
define('COM_VIRTUEMART_FEED_MAX_TEXT_LENGTH', '250');
define('COM_VIRTUEMART_STORE_CREDITCARD_DATA', '1');
define('COM_VIRTUEMART_ENCRYPT_FUNCTION', 'AES_ENCRYPT');
define('COM_VIRTUEMART_COMPONENT_NAME', 'com_virtuemart');
define('COM_VIRTUEMART_LOGFILE_ENABLED', '');
define('COM_VIRTUEMART_LOGFILE_NAME', '');
define('COM_VIRTUEMART_LOGFILE_LEVEL', 'PEAR_LOG_WARNING');
define('COM_VIRTUEMART_DEBUG_IP_ENABLED', '');
define('COM_VIRTUEMART_DEBUG_IP_ADDRESS', '');
define('COM_VIRTUEMART_LOGFILE_FORMAT', '%{timestamp} %{ident} [%{priority}] [%{remoteip}] [%{username}] %{message}');
define('COM_VIRTUEMART_DATE_FORMAT', '%m/%d/%y');
