...
(null, 1, 0, 'COM_VIRTUEMART_PRODUCT_FILES_LIST_MNU', '', '', 'vmicon vmicon-16-content', 5, 1, '', 'media', 'media'),
(null, 1, 0, 'COM_VIRTUEMART_PRODUCT_INVENTORY_MNU', '', '', 'vmicon vmicon-16-install', 6, 1, '', 'inventory', 'inventory'),
(null, 1, 0, 'COM_VIRTUEMART_CALCULATOR', '', '', 'vmicon vmicon-16-content', 7, 1, '', 'calc', ''),
(null, 1, 0, 'COM_VIRTUEMART_REVIEWS', '', '', 'vmicon vmicon-16-content', 8, 1, '', 'ratings', 'ratings'),
(null, 1, 0, 'COM_VIRTUEMART_SPECIAL_PRODUCTS', '', '', 'vmicon vmicon-16-content', 9, 0, '', 'productspecial', 'productSpecial'),
...
(null, 2, 0, 'COM_VIRTUEMART_SHOPPERS', '', '', 'vmicon vmicon-16-user', 4, 1, '', 'user', ''),
...
(null, 5, 0, 'COM_VIRTUEMART_CONFIG', '', '', 'vmicon vmicon-16-config', 1, 1, '', 'config', ''),
(null, 5, 0, 'COM_VIRTUEMART_CURRENCY_LIST_MNU', '', '', 'vmicon vmicon-16-content', 2, 1, '', 'currency', ''),
(null, 5, 0, 'COM_VIRTUEMART_CREDITCARD_LIST_LBL', '', '', 'vmicon vmicon-16-content', 3, 1, '', 'creditcard', ''),
(null, 5, 0, 'COM_VIRTUEMART_COUNTRY_LIST_MNU', '', '', 'vmicon vmicon-16-content', 4, 1, '', 'country', ''),
(null, 5, 0, 'COM_VIRTUEMART_MANAGE_USER_FIELDS', '', '', 'vmicon vmicon-16-content', 5, 1, '', 'userfields', ''),
...
(null, 11, 0, 'COM_VIRTUEMART_ABOUT', '', '', 'vmicon vmicon-16-info', 2, 0, '', '', ''),
