...
--
INSERT INTO `#__vm_menu_admin` (`id`, `module_id`, `parent_id`, `name`, `link`, `depends`, `icon_class`, `ordering`, `enabled`, `tooltip`, `view`, `task`) VALUES
...
INSERT INTO `#__vm_module` (`module_id`, `module_name`, `module_description`, `module_perms`, `enabled`, `is_admin`, `list_order`) VALUES
...
INSERT INTO `#__vm_userfield` (`fieldid`, `name`, `title`, `description`, `type`, `maxlength`, `size`, `required`, `ordering`, `cols`, `rows`, `value`, `default`, `enabled`, `registration`, `shipping`, `account`, `readonly`, `calculated`, `sys`, `vendor_id`, `params`) VALUES
