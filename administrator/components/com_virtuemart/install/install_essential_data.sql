...
(null, 4, 0, 'COM_VIRTUEMART_USERS', '', '', 'vmicon vmicon-16-user', 1, 1, '', 'user', ''),
(null, 77, 0, 'COM_VIRTUEMART_USERGROUP_LBL', '', '', 'vmicon vmicon-16-user', 2, 1, '', 'usergroups', ''),
(null, 1, 0, 'COM_VIRTUEMART_MANAGE_USER_FIELDS', '', '', 'vmicon vmicon-16-content', 2, 1, '', 'userfields', ''),
(null, 1, 0, 'COM_VIRTUEMART_COUNTRY_LIST_MNU', '', '', 'vmicon vmicon-16-content', 5, 1, '', 'country', ''),
(null, 1, 0, 'COM_VIRTUEMART_CURRENCY_LIST_MNU', '', '', 'vmicon vmicon-16-content', 4, 1, '', 'currency', ''),
(null, 77, 0, 'COM_VIRTUEMART_CHECK_UPDATES_MNU', '', '', 'vmicon vmicon-16-content', 1, 1, '', 'updatesmigration', ''),
(null, 14, 0, 'COM_VIRTUEMART_STATISTIC_SUMMARY', '', '', 'vmicon vmicon-16-info', 1, 1, '', 'virtuemart', ''),
(null, 8, 0, 'COM_VIRTUEMART_STORE_FORM_MNU', '', '', 'vmicon vmicon-16-config', 1, 1, '', 'user', 'editshop'),
(null, 2, 0, 'COM_VIRTUEMART_CALCULATOR', '', '', 'vmicon vmicon-16-content', 8, 1, '', 'calc', ''),
(null, 1, 0, 'COM_VIRTUEMART_PAYMENT_METHOD_LIST_MNU', '', '', 'vmicon vmicon-16-content', 4, 1, '', 'paymentmethod', ''),
(null, 1, 0, 'COM_VIRTUEMART_CREDITCARD_LIST_LBL', '', '', 'vmicon vmicon-16-content', 10, 1, '', 'creditcard', ''),
(null, 2, 0, 'COM_VIRTUEMART_PRODUCT_LIST_MNU', '', '', 'vmicon vmicon-16-content', 2, 1, '', 'product', 'product'),
(null, 2, 0, 'COM_VIRTUEMART_PRODUCT_INVENTORY_MNU', '', '', 'vmicon vmicon-16-install', 6, 1, '', 'inventory', 'inventory'),
(null, 2, 0, 'COM_VIRTUEMART_SPECIAL_PRODUCTS', '', '', 'vmicon vmicon-16-content', 7, 1, '', 'productspecial', 'productSpecial'),
(null, 2, 0, 'COM_VIRTUEMART_REVIEWS', '', '', 'vmicon vmicon-16-content', 9, 1, '', 'ratings', 'ratings'),
(null, 2, 0, 'COM_VIRTUEMART_PRODUCT_TYPE_LIST_MNU', '', '', 'vmicon vmicon-16-content', 4, 1, '', 'producttypes', ''),
(null, 2, 0, 'COM_VIRTUEMART_CATEGORY_LIST_MNU', '', '', 'vmicon vmicon-16-content', 1, 1, '', 'category', ''),
...
(null, 1, 0, 'COM_VIRTUEMART_ORDER_STATUS_LIST_MNU', '', '', 'vmicon vmicon-16-orderstatus', 3, 1, '', 'orderstatus', ''),
(null, 5, 0, 'COM_VIRTUEMART_REPORT_BASIC_MNU', '', '', 'vmicon vmicon-16-info', 3, 1, '', 'report', 'basic'),
(null, 1, 0, 'COM_VIRTUEMART_CARRIER_LIST_MNU', '', '', 'vmicon vmicon-16-content', 20, 1, '', 'shippingcarrier', ''),
(null, 1, 0, 'COM_VIRTUEMART_RATE_LIST_MNU', '', '', 'vmicon vmicon-16-content', 21, 1, '', 'shippingrate', ''),
(null, 5, 0, 'COM_VIRTUEMART_COUPON_LIST_MNU', '', '', 'vmicon vmicon-16-content', 2, 1, '', 'coupon', ''),
(null, 99, 0, 'COM_VIRTUEMART_MANUFACTURER_LIST_MNU', '', '', 'vmicon vmicon-16-content', 2, 1, '', 'manufacturer', ''),
(null, 99, 0, 'COM_VIRTUEMART_MANUFACTURER_CAT_LIST_MNU', '', '', 'vmicon vmicon-16-content', 1, 1, '', 'manufacturercategory', ''),
...
(2, 'product', '<p>Here you can adminster your online catalog of products.  The Product Administrator allows you to create product categories, create new products, edit product attributes, and add product items for each attribute value.</p>', 'storeadmin,admin', 1, '1', 2),
...
(5, 'order', '<p>View Order and Update Order Status.</p>', 'admin,storeadmin', 1, '1', 2),
...
(8, 'store', '', 'storeadmin,admin', 1, '1', 6),
...
(77, 'tools', 'For the categories', 'admin,storeadmin', 1, '1', 8),
(12, 'report', 'The report module allows administrative queries relating to orders.', 'admin,storeadmin', 1, '1', 9),
...
(99, 'manufacturer', 'Manage the manufacturers of products in your store.', 'storeadmin,admin', 1, '1', 4),
(12842, 'help', 'Help Module', 'admin,storeadmin', 1, '1', 10),
(14, 'Summary', 'Summary', 'admin,storeadmin', 1, '1', 1);
