...
INSERT INTO `#__virtuemart_orderstates` (`virtuemart_orderstate_id`, `order_status_code`, `order_status_name`, `order_stock_handel`, `ordering`, `virtuemart_vendor_id`) VALUES
(null, 'P', 'Pending', '', 'R',1, 1),`order_status_description`,
