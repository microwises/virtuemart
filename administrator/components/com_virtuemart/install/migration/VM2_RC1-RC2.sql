...
ALTER TABLE `jos_vm_product_media_xref` ADD UNIQUE KEY `i_product_id` (`product_id`,`virtuemart_media_ids`);
...
ALTER TABLE `jos_vm_vendor_media_xref` ADD UNIQUE KEY `i_vendor_id` (`vendor_id`,`virtuemart_media_ids`);
