...
INSERT INTO `#__vm_function` VALUES ('', 1, 'userfieldSave', 'ps_userfield', 'savefield', 'add or edit a user field', 'admin');
INSERT INTO `#__vm_function` VALUES ('', 1, 'userfieldDelete', 'ps_userfield', 'deletefield', '', 'admin');
INSERT INTO `#__vm_function` VALUES ('', 1, 'changeordering', 'vmAbstractObject.class', 'handleordering', '', 'admin');
INSERT INTO `#__vm_function` VALUES ('', 2, 'moveProduct', 'ps_product', 'move', 'Move products from one category to another.', 'admin,storeadmin');


# Allow percentages as payment method discount

ALTER IGNORE TABLE `#__vm_payment_method` 
...
# NEW Countries
INSERT INTO `#__vm_country` (country_name, country_3_code, country_2_code)
VALUES
    ('East Timor', 'XET', 'XE'),
    ('Jersey', 'XJE', 'XJ'),
...
# NEW Currencies
INSERT INTO `#__vm_currency` (currency_name, currency_code)
VALUES
    ('Armenian Dram', 'AMD'),
    ('Peruvian Nuevo Sol', 'PEN');
    
# 10.04.2006
ALTER IGNORE TABLE `#__vm_product_reviews` ADD `review_id` INT( 11 ) NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST ;
ALTER IGNORE TABLE `#__vm_product_reviews` ADD UNIQUE ( `product_id` , `userid` );

ALTER IGNORE TABLE `#__vm_product_votes` ADD PRIMARY KEY ( `product_id` ) ;
ALTER IGNORE TABLE `#__vm_zone_shipping` DROP INDEX `zone_id`;

# 13.04.2006 for JoomFish
ALTER IGNORE TABLE `#__vm_product_attribute` ADD `attribute_id` INT( 11 ) NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST ;
# Ask a question!
INSERT INTO `#__vm_function` VALUES (NULL, 7, 'productAsk', 'ps_communication', 'mail_question', 'Lets the customer send a question about a specific product.', 'admin,storeadmin,shopper,demo');
INSERT INTO `#__vm_function` VALUES (NULL, 2, 'reviewUpdate', 'ps_reviews', 'update', 'Modify a review about a specific product.', 'admin');
INSERT INTO `#__vm_function` VALUES (NULL, 7, 'recommendProduct', 'ps_communication', 'sendRecommendation', 'Lets the customer send a recommendation about a specific product to a friend.', 'none');
INSERT INTO `#__vm_function` VALUES (NULL, 8, 'ExportUpdate', 'ps_export', 'update', '', 'admin,storeadmin');
INSERT INTO `#__vm_function` VALUES (NULL, 8, 'ExportAdd', 'ps_export', 'add', '', 'admin,storeadmin');
INSERT INTO `#__vm_function` VALUES (NULL, 8, 'ExportDelete', 'ps_export', 'delete', '', 'admin,storeadmin');
INSERT INTO `#__vm_function` VALUES (NULL, 1, 'writeThemeConfig', 'ps_config', 'writeThemeConfig', 'Writes a theme configuration file.', 'admin');


# Prevent auto-publishing of product reviews
ALTER IGNORE TABLE `#__vm_product_reviews` ADD `published` CHAR( 1 ) NOT NULL DEFAULT 'Y';

# 02.05.2006 Multi-Currency Feature
ALTER IGNORE TABLE `#__vm_vendor` ADD `vendor_accepted_currencies` TEXT NOT NULL ;

# 12.09.2006 improve category listing performance
ALTER IGNORE TABLE `#__vm_category_xref` DROP INDEX `category_xref_category_child_id` ;
ALTER IGNORE TABLE `#__vm_category_xref` ADD PRIMARY KEY ( `category_child_id` ) ;

# 13.09.2006 Allow Order Status Descriptions
ALTER IGNORE TABLE `#__vm_order_status` ADD `order_status_description` TEXT NOT NULL AFTER `order_status_name`;

# 06.11.2006 Track coupon code used to order
ALTER IGNORE TABLE `#__vm_orders` ADD `coupon_code` VARCHAR( 32 ) NULL AFTER `coupon_discount` ;
...
INSERT INTO `#__vm_auth_user_group` 
				SELECT user_id, 
					CASE `perms` 
					    WHEN 'admin' THEN 0
...
INSERT INTO `#__vm_function` VALUES 
...
ALTER IGNORE TABLE `#__vm_product` ADD `child_options` varchar(45) default NULL;
ALTER IGNORE TABLE `#__vm_product` ADD `quantity_options` varchar(45) default NULL;
ALTER IGNORE TABLE `#__vm_product` ADD  `child_option_ids` varchar(45) default NULL;
ALTER IGNORE TABLE `#__vm_product` ADD  `product_order_levels` varchar(45) default NULL;
...
UPDATE `#__components` SET `params` = 'RELEASE=1.1.0\nDEV_STATUS=RC3' WHERE `name` = 'virtuemart_version';
