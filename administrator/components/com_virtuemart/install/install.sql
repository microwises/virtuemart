...
CREATE TABLE IF NOT EXISTS `#__virtuemart_calcs` (
  ...
  `calc_params` text NOT NULL DEFAULT '',
  `ordering` int(2) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_medias` (
  ...
  `file_params` text NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_orderstates` (
  ...
  `order_status_description` text NOT NULL DEFAULT '',
  `ordering` int(2) NOT NULL DEFAULT '0',
  `published` tinyint(1) NOT NULL DEFAULT '1',
 `created_on` datetime NOT NULL default '0000-00-00 00:00:00',
  `created_by` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_products` (
  ...
  `product_lwh_uom` char(7) NOT NULL DEFAULT 'M',
  ...
  `hits` int(11) unsigned NOT NULL DEFAULT '0',
  `intnotes` text,
  `metarobot` text NOT NULL DEFAULT '',
  `metaauthor` text NOT NULL DEFAULT '',
  `layout` char(16) NOT NULL DEFAULT '',
  `published` tinyint(1) NOT NULL DEFAULT '1',
  `created_on` datetime NOT NULL default '0000-00-00 00:00:00',
  `created_by` int(11) NOT NULL DEFAULT '0',
  `modified_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
