...
DELETE FROM `#__virtuemart_manufacturer_categories`;
DELETE FROM `#__virtuemart_orders`;
DELETE FROM `#__virtuemart_order_history`;
...
DELETE FROM `#__virtuemart_products_attribute`;
-- DELETE FROM `#__virtuemart_products_attribute_sku`;
...
DELETE FROM `#__virtuemart_product_reviews`;
DELETE FROM `#__virtuemart_users`;
