...
//    				file_ids AS file_name, file_ids AS file_title, '0' AS isdownloadable, product_name,
//    				CONCAT('".VmConfig::get('media_product_path')."','product/', file_ids) AS file_url, SUBSTRING(file_ids, -3, 3) AS file_extension
//    		FROM #__vm_product
//    		WHERE LENGTH(file_ids) > 0 ";
//    	$q .= $filter;
//    	$q .= " ORDER BY file_is_image DESC";
//    	$db->setQuery($q);
