...
//require(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_virtuemart'.DS.'libraries'.DS.'CategoryUtils.php');
//require(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_virtuemart'.DS.'libraries'.DS.'ProductUtils.php');
