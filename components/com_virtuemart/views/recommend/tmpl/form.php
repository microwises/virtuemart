...
<div class="ask-a-question-view">
	<div class="spacer">
		...
		<div class="form-field">
			...
			<form method="post" class="form-validate" action="<?php echo JRoute::_('index.php?option=com_virtuemart&view=productdetails&product_id='.$this->product->product_id.'&virtuemart_category_id='.$this->product->virtuemart_category_id).'&tmpl=component' ; ?>" name="askform" id="askform" onSubmit="return myValidate(this);">
