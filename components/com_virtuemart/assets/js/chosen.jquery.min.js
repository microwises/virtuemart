  ...
  */  var $, Chosen, SelectParser, get_side_border_padding, root;
  ...
  Chosen = (function() {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        container_div.html('<ul class="chzn-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" style="display:none;position: static;" /></li></ul><div class="chzn-drop" style="display:none;"><ul class="chzn-results"></ul></div>');
      } else {
        container_div.html('<a href="javascript:void(0)" class="chzn-single"><span>' + this.default_text + '</span><div><b></b></div></a><div class="chzn-drop" style="display:none;position: static;"><div class="chzn-search"><input type="text" /></div><ul class="chzn-results"></ul></div>');
      }
