...
<script type="text/javascript">
     <!--
            ...
            klarna.select_spec_bday    = '<?php echo @$viewData['value']['birth_day'] ; ?>';
            klarna.select_spec_bmonth    = '<?php echo @$viewData['value']['birth_month'] ; ?>';
            klarna.select_spec_byear    = '<?php echo @$viewData['value']['birth_year'] ; ?>';
            ...
            <div class="klarna_box_bottom_contents">
                ...
                <div class="klarna_box_bottom_right">
                    <div class="klarna_box_bottom_content">
                        ...
                        <input type="radio" name="<?php echo $viewData['input']['gender'] ; ?>" value="1" id="spec_male"
                        ...
                        <div class="klarna_box_bottom_input_combo" style="width: 100%">
                            <input type="checkbox" name="<?php echo $viewData['input']['consent'] ; ?>"
                                ...
                                <div class="klarna_box_bottom_title" style="width: 80%; margin-top: 3px">Mit der &Uuml;bermittlung der f&uuml;r die Abwicklung des Rechnungskaufes und einer Identit&auml;ts- und Bonit&auml;tspr&uuml;fung erforderlichen Daten an Klarna bin ich einverstanden. Meine <a href="javascript:ShowKlarnaConsentPopup('<?php echo $viewData['setup']['eid'] ; ?>','spec')">Einwilligung</a> kann ich jederzeit mit Wirkung f&uuml;r die Zukunft widerrufen. Es gelten die <a href="<?php echo $viewData['setup']['agb_link'] ; ?>">AGB</a> des H&auml;ndlers.</div>
                        </div>
                    </div>
                </div>
            </div>
