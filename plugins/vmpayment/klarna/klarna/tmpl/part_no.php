            ...
            <div id="klarna_box_part_top_right" class="klarna_box_top_right">
                ...
                <div class="klarna_box_bottom_languageInfo">
                    <img src="<?php echo VMKLARNAPLUGINWEBASSETS.'images/' ?>share/notice.png"
                        alt="<?php echo JText::_('VMPAYMENT_KLARNA_LANGUAGESETTING_NOTE_NO'); ?>" />
                </div>
            </div>
            <img src="<?php echo VMKLARNAPLUGINWEBASSETS.'images/' ?>logo/klarna_account_<?php echo $params['setup']['countryCode'] ; ?>.png"
		 id="klarna_logo_part" class="klarna_logo" alt="<?php echo JText::_('VMPAYMENT_KLARNA_IMG_LOGO_ACCOUNT'); ?>"/>
        </div>
        <div class="klarna_box_bottom">
            <div class="klarna_box_bottom_contents">
                ...
                <div class="klarna_box_bottom_right">
                    <div class="klarna_box_bottom_content">
                        <div class="klarna_box_bottom_title" id="part_perOrg_title"><?php echo JText::_('VMPAYMENT_KLARNA_PERSON_NUMBER'); ?></div>
                        <input alt="<?php echo JText::_('VMPAYMENT_KLARNA_NOTICE_SOCIALNUMBER_PART_NO'); ?>" type="text"
                        ...
                        <div class="klarna_box_bottom_input_combo" style="width: 100%">
                            ...
                            <div id="right" style="width: 60%">
                                ...
                                <input alt="<?php echo JText::_('VMPAYMENT_KLARNA_NOTICE_CITY'); ?>" type="text" name="<?php echo $params['input']['city'] ; ?>" value="<?php echo @$params['value']['city'] ; ?>" style="width: 100%" />
                            </div>
                        </div>
                    </div>
                </div>
