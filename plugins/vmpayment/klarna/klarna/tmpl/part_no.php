                    ...
                    <div class="klarna_box_bottom_content">
                        ...
                        <div class="klarna_box_bottom_input_combo" style="width: 100%">
                            ...
                            <div id="right" style="width: 60%">
                                ...
                                <input alt="<?php echo JText::_('VMPAYMENT_KLARNA_NOTICE_CITY'); ?>" type="text" name="<?php echo $viewData['input']['city'] ; ?>" value="<?php echo @$viewData['value']['city'] ; ?>" style="width: 100%" />
                            </div>
                        </div>
                    </div>
                </div>
