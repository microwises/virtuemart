            ...
            <div class="klarna_box_bottom_contents">
                ...
                <div class="klarna_box_bottom_right">
                    <div class="klarna_box_bottom_content">
                        ...
                        <input alt="<?php echo JText::_('VMPAYMENT_KLARNA_NOTICE_SOCIALNUMBER_PART_DK'); ?>" type="text"
                        ...
                        <div class="klarna_box_bottom_title"><?php echo JText::_('VMPAYMENT_KLARNA_YEAR_SALARY'); ?></div>
                        <input alt="<?php echo JText::_('VMPAYMENT_KLARNA_NOTICE_YEAR_SALARY_DKK'); ?>" type="text"
                            name="<?php echo $params['input']['year_salary'] ; ?>" value="<?php echo @$params['value']['year_salary'] ; ?>"
                            class="Klarna_fullwidth" />
                    </div>
                </div>
            </div>
