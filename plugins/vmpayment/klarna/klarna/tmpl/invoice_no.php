            ...
            <div class="klarna_box_bottom_contents">
                <div class="klarna_box_bottom_right">
                    <div class="klarna_box_bottom_content">
                        ...
                        <input alt="<?php echo JText::_('VMPAYMENT_KLARNA_NOTICE_SOCIALNUMBER_NO'); ?>" type="text" name="<?php echo $params['input']['socialNumber'] ; ?>" value="<?php echo @$params['value']['socialNumber'] ; ?>" class="Klarna_fullwidth" />
                        <div class="klarna_box_bottom_input_combo" style="width: 100%"
                            ...
                            <div id="left" style="width: 60%">
                                ...
                                <input alt="<?php echo JText::_('VMPAYMENT_KLARNA_NOTICE_FIRSTNAME'); ?>" type="text" name="<?php echo $params['input']['firstName'] ; ?>" value="<?php echo @$params['value']['firstName'] ; ?>" style="width: 98%" />
                            </div>
                            <div id="right" style="width: 40%">
                                <div class="klarna_box_bottom_title"><?php echo JText::_('VMPAYMENT_KLARNA_LAST_NAME'); ?></div>
                                <input alt="<?php echo JText::_('VMPAYMENT_KLARNA_NOTICE_LASTNAME'); ?>" type="text" name="<?php echo $params['input']['lastName'] ; ?>" value="<?php echo @$params['value']['lastName'] ; ?>" style="width: 100%" />
                            </div>
                        </div>
                        <div class="klarna_box_bottom_input_combo"
                            ...
                            <div id="left" style="width: 60%">
                                ...
                                <input alt="<?php echo JText::_('VMPAYMENT_KLARNA_NOTICE_COMPANYNAME'); ?>" type="text"  name="<?php echo $params['input']['companyName'] ; ?>" value="<?php echo @$params['value']['companyName'] ; ?>" style="width: 98%" />
                            </div>
                            <div id="right" style="width: 40%">
                                <div class="klarna_box_bottom_title"><?php echo JText::_('VMPAYMENT_KLARNA_REFERENCE'); ?></div>
                                <input alt="<?php echo JText::_('VMPAYMENT_KLARNA_NOTICE_REFERENCE'); ?>" type="text" name="<?php echo $params['input']['reference'] ; ?>" value="<?php echo @$params['value']['reference'] ; ?>" style="width: 100%" />
                            </div>
                        </div>
                        <div class="klarna_box_bottom_input_combo" style="width: 100%">
