...
// 		self::$_this
	...
	$automatic_shipmentmethod_id= $this->onCheckAutomaticSelected($cart, $cart_prices);
	if ($automatic_shipmentmethod_id != null) {
	    if ($automatic_shipmentmethod_id) {
		$shipCounter ++;
	    } else {
		$shipCounter+=2;
	    }
	...
	return $automatic_shipmentmethod_id;
    }
